...
export default function AuditPage() {
  ...
  if (!allowed) return <div className="space-y-7"><PageHeader eyebrow="Governanca" title="Auditoria" description="Historico imutavel das alteracoes criticas da operacao." /><div className="alert border-amber-200 bg-amber-50 text-amber-800"><ShieldCheck className="mr-2 inline h-4 w-4" />Seu perfil nao possui permissao para consultar logs de auditoria.</div></div>;
  if (query.isLoading) return <LoadingState />;

  return (
    <div className="space-y-7">
      <PageHeader eyebrow="Governanca e rastreabilidade" title="Auditoria" description="Registro automatico de inclusoes, alteracoes e eventos sensiveis por organizacao e usuario." />
